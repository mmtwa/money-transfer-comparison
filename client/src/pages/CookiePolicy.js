...
const CookiePolicy = () => {
  return (
    <div>
      <SEO 
        title=" Cookie Policy | MyMoneyTransfers"
        description=" Cookie Policy - MyMoneyTransfers provides detailed information to help you make informed decisions about international money transfers."
