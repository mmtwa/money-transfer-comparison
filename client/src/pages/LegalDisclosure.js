...
const LegalDisclosure = () => {
  return (
    <div>
      <SEO 
        title=" Legal Disclosure | MyMoneyTransfers"
        description=" Legal Disclosure - MyMoneyTransfers provides detailed information to help you make informed decisions about international money transfers."
        canonicalUrl="/legal-disclosure"
      />
