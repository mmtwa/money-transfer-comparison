...
const SendMoneyToMoroccoGuide = () => {
  ...
  const content = (
    <>
      <div className="guide-container">
        <p>Navigate exchange controls, find the best providers, and understand the unique aspects of UK to Morocco transfers.</p>
  ...
  return (
    <GuideDetail
      ...
      subtitle="Find the best ways to transfer money to Morocco - compare fees, exchange rates, and transfer speeds."
      content={content}
