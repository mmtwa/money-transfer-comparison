...
const SendMoneyToRomaniaGuide = () => {
  ...
  const content = (
    <>
      <div className="guide-container">
        <p>Best options for sending money to Romania, including digital transfers, cash pickup options, and banking preferences across different Romanian regions.</p>
  ...
  return (
    <GuideDetail
      ...
      subtitle="Find the best ways to transfer money to Romania - compare fees, exchange rates, and transfer speeds."
      content={content}
