...
const SendMoneyToChinaGuide = () => {
  ...
  const content = (
    <>
      <div className="guide-container">
        <p>Navigate China's unique regulations and find the best providers for sending money to China. Learn about documentation requirements and regional considerations.</p>
  ...
  return (
    <GuideDetail
      ...
      subtitle="Find the best ways to transfer money to China - compare fees, exchange rates, and transfer speeds."
      content={content}
