...
const TransferFees = () => {
  return (
    <>
      <SEO 
        title=" Transfer Fees | MyMoneyTransfers"
        description=" Transfer Fees - MyMoneyTransfers provides detailed information to help you make informed decisions about international money transfers."
        canonicalUrl="/guides\transfer-fees"
      />
      <GuideDetail
        title=" Transfer Fees | MyMoneyTransfers"
        subtitle=" Transfer Fees | MyMoneyTransfers"
