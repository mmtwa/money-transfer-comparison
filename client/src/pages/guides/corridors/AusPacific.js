...
import heroImageJpg from '../../../assets/images/guides/aus-pacific-hero-optimized.jpg';
import heroImageWebp from '../../../assets/images/guides/aus-pacific-hero.webp';

/**
 * Guide to Australia to Pacific money transfers
 */
const AusPacific = () => {
  ...
  const content = (
    <>
      ...
      >
        The Complete Guide to Sending Money from Australia to the Pacific: Your Essential Resource for 2025
      </ClickableHeadline>
      {expandedSections['introduction'] && (
        <>
          <p className="mb-6 text-left">
            With over A$2.5 billion sent annually from Australia to Pacific nations, understanding the most efficient and cost-effective ways to transfer money has never been more important. Whether you're supporting family, investing in business opportunities, or managing international payments, this comprehensive guide will help you navigate the complex landscape of Australia to Pacific money transfers.
          </p>
          
          <div className="bg-indigo-50 p-6 rounded-lg my-8">
            <h3 className="text-xl font-bold text-indigo-800 mb-3 text-left">Why This Guide Matters</h3>
            <p className="mb-4 text-left">
              "When I first started sending money to my family in Fiji, I was losing nearly A$35 on every A$1,000 transfer due to hidden fees and poor exchange rates," shares Laisani Tui, a Sydney-based nurse. "Understanding the different options available has helped me save thousands over the years."
            </p>
      ...
      {expandedSections['key-markets'] && (
        <>
          <p className="mb-4 text-left">
            The Australia to Pacific corridor encompasses several major markets, each with unique characteristics and requirements.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white shadow-sm rounded p-5">
              ...
              <ul className="list-disc pl-8">
                <li className="text-left">Fiji - A$450 million annually</li>
                <li className="text-left">Samoa - A$380 million annually</li>
                <li className="text-left">Tonga - A$320 million annually</li>
                <li className="text-left">Vanuatu - A$280 million annually</li>
                <li className="text-left">Solomon Islands - A$250 million annually</li>
              </ul>
            </div>
            ...
            <div className="bg-white shadow-sm rounded p-5">
              ...
              <ul className="list-disc pl-8">
                <li className="text-left">Average transfer size: A$300-A$800</li>
                <li className="text-left">Frequency: Monthly or bi-monthly</li>
        ...
        <>
          ...
          <div className="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <ul className="list-disc pl-8 mb-4">
              ...
              <li className="mb-2 text-left"><strong>Mobile Money Services</strong>: Growing in popularity in certain markets</li>
      ...
      {expandedSections['cost-comparison'] && (
        <>
          ...
          <div className="bg-yellow-50 p-6 border-l-4 border-yellow-400 rounded-r-lg my-8">
            ...
            <ul className="list-disc pl-8">
              <li className="text-left"><strong>Transfer Fees</strong>: Can range from A$0 to A$15 per transfer</li>
              <li className="text-left"><strong>Exchange Rate Margin</strong>: Typically 1% to 2.5% of the transfer amount</li>
        ...
        <>
          ...
          <div className="space-y-8 ml-4 pl-6 border-l-2 border-indigo-200 mb-8">
            <div className="relative">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-1 text-left">Australian Regulations</h3>
              <p className="mb-4 text-left">
                AUSTRAC-regulated providers must comply with strict anti-money laundering and counter-terrorism financing requirements. Expect to provide identification and proof of funds source for transfers over A$1,000.
              </p>
            </div>
            
            <div className="relative">
              <div className="absolute left-[-33px] top-1 h-5 w-5 rounded-full bg-indigo-600"></div>
              <h3 className="text-xl font-bold text-gray-700 mb-1 text-left">Pacific Market Regulations</h3>
              <p className="mb-4 text-left">
                Each country has its own regulatory framework. For example, Fiji requires FNPF details for transfers over A$1,000, while some countries have specific documentation requirements for larger transfers.
              </p>
            </div>
          </div>
        </>
      ...
      {expandedSections['success-stories'] && (
        <>
          <p className="mb-6 text-left">
            Real experiences from people who have successfully managed their Australia to Pacific transfers.
          </p>
          ...
          <div className="bg-indigo-50 p-6 rounded-lg my-8">
            ...
            <div className="space-y-4">
              <p className="text-left">
                "By using a specialist provider and timing my transfers around market hours, I've saved over A$800 in the last year on my regular transfers to Fiji," shares Sione Vaka, a Brisbane-based teacher.
              </p>
              <p className="text-left">
                "Setting up a regular transfer schedule with my provider not only saved me money but also made the process much more convenient," says Malia Tupou, who sends money to Tonga monthly.
              </p>
            </div>
          </div>
          ...
          <p className="mb-6 text-left">
            Sending money from Australia to Pacific nations requires careful consideration of various factors, from costs and speed to regulatory compliance. By following this guide and staying informed about market changes, you can ensure your transfers are both efficient and cost-effective.
          </p>
          <p className="text-left">
  ...
  return (
    <GuideDetail
      title="The Complete Guide to Sending Money from Australia to the Pacific: Your Essential Resource for 2025"
      subtitle="Everything you need to know about transferring money from Australia to Pacific nations, from costs to compliance"
      content={content}
