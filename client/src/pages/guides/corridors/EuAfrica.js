...
import heroImageJpg from '../../../assets/images/guides/eu-africa-hero-optimized.jpg';
import heroImageWebp from '../../../assets/images/guides/eu-africa-hero.webp';

/**
 * Guide to Europe to Africa money transfers
 */
const EuAfrica = () => {
  ...
  const content = (
    <>
      ...
      >
        The Complete Guide to Sending Money from Europe to Africa: Your Essential Resource for 2025
      </ClickableHeadline>
      {expandedSections['introduction'] && (
        <>
          <p className="mb-6 text-left">
            With over €25 billion sent annually from Europe to Africa, understanding the most efficient and cost-effective ways to transfer money has never been more important. Whether you're supporting family, investing in business opportunities, or managing international payments, this comprehensive guide will help you navigate the complex landscape of Europe to Africa money transfers.
          </p>
          
          <div className="bg-indigo-50 p-6 rounded-lg my-8">
            <h3 className="text-xl font-bold text-indigo-800 mb-3 text-left">Why This Guide Matters</h3>
            <p className="mb-4 text-left">
              "When I first started sending money to my family in Nigeria, I was losing nearly €40 on every €1,000 transfer due to hidden fees and poor exchange rates," shares Adebayo Ogunleye, a London-based healthcare worker. "Understanding the different options available has helped me save thousands over the years."
            </p>
      ...
      {expandedSections['key-markets'] && (
        <>
          <p className="mb-4 text-left">
            The Europe to Africa corridor encompasses several major markets, each with unique characteristics and requirements.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white shadow-sm rounded p-5">
              ...
              <ul className="list-disc pl-8">
                <li className="text-left">Nigeria - €8.5 billion annually</li>
                <li className="text-left">Ghana - €3.2 billion annually</li>
                <li className="text-left">Kenya - €2.8 billion annually</li>
                <li className="text-left">Senegal - €2.1 billion annually</li>
                <li className="text-left">Morocco - €4.2 billion annually</li>
              </ul>
            </div>
            ...
            <div className="bg-white shadow-sm rounded p-5">
              ...
              <ul className="list-disc pl-8">
                <li className="text-left">Average transfer size: €200-€500</li>
        ...
        <>
          ...
          <div className="bg-white shadow-md rounded-lg p-6 mb-8">
            ...
            <ul className="list-disc pl-8 mb-4">
              ...
              <li className="mb-2 text-left"><strong>Mobile Money Services</strong>: Growing in popularity across Africa</li>
      ...
      {expandedSections['cost-comparison'] && (
        <>
          ...
          <div className="bg-yellow-50 p-6 border-l-4 border-yellow-400 rounded-r-lg my-8">
            ...
            <ul className="list-disc pl-8">
              <li className="text-left"><strong>Transfer Fees</strong>: Can range from €0 to €20 per transfer</li>
              <li className="text-left"><strong>Exchange Rate Margin</strong>: Typically 1% to 3% of the transfer amount</li>
        ...
        <>
          ...
          <div className="space-y-8 ml-4 pl-6 border-l-2 border-indigo-200 mb-8">
            <div className="relative">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-1 text-left">European Regulations</h3>
              <p className="mb-4 text-left">
                EU-regulated providers must comply with strict anti-money laundering and counter-terrorism financing requirements. Expect to provide identification and proof of funds source for transfers over €1,000.
              </p>
            </div>
            
            <div className="relative">
              <div className="absolute left-[-33px] top-1 h-5 w-5 rounded-full bg-indigo-600"></div>
              <h3 className="text-xl font-bold text-gray-700 mb-1 text-left">African Market Regulations</h3>
              <p className="mb-4 text-left">
                Each country has its own regulatory framework. For example, Nigeria requires BVN for transfers over €1,000, while some countries have specific documentation requirements for larger transfers.
              </p>
            </div>
          </div>
        </>
      ...
      {expandedSections['success-stories'] && (
        <>
          <p className="mb-6 text-left">
            Real experiences from people who have successfully managed their Europe to Africa transfers.
          </p>
          ...
          <div className="bg-indigo-50 p-6 rounded-lg my-8">
            ...
            <div className="space-y-4">
              <p className="text-left">
                "By using a specialist provider and timing my transfers around market hours, I've saved over €1,000 in the last year on my regular transfers to Nigeria," shares Kofi Mensah, a London-based engineer.
              </p>
              <p className="text-left">
                "Setting up a regular transfer schedule with my provider not only saved me money but also made the process much more convenient," says Fatima Hassan, who sends money to Morocco monthly.
              </p>
            </div>
          </div>
          ...
          <p className="mb-6 text-left">
            Sending money from Europe to Africa requires careful consideration of various factors, from costs and speed to regulatory compliance. By following this guide and staying informed about market changes, you can ensure your transfers are both efficient and cost-effective.
          </p>
          <p className="text-left">
  ...
  return (
    <GuideDetail
      title="The Complete Guide to Sending Money from Europe to Africa: Your Essential Resource for 2025"
      subtitle="Everything you need to know about transferring money from Europe to African countries, from costs to compliance"
      content={content}
