...
const ExchangeRates = () => {
  ...
  const sections = {
    'what-are-exchange-rates': true,
    'mid-market-vs-provider': true,
    'influences-exchange-rates': true,
    'exchange-rate-volatility': true,
    'compare-exchange-rates': true
  };
  ...
  const content = (
    <>
      <ClickableHeadline 
        id="what-are-exchange-rates" 
        isExpanded={expandedSections['what-are-exchange-rates']} 
        onClick={toggleSection}
      >
        What Are Exchange Rates?
      </ClickableHeadline>
      {expandedSections['what-are-exchange-rates'] && (
        <>
      ...
      <ClickableHeadline 
        id="mid-market-vs-provider" 
        isExpanded={expandedSections['mid-market-vs-provider']} 
        onClick={toggleSection}
      >
        The Mid-Market Rate vs. Provider Rates
      </ClickableHeadline>
      {expandedSections['mid-market-vs-provider'] && (
        <>
      ...
      <ClickableHeadline 
        id="influences-exchange-rates" 
        isExpanded={expandedSections['influences-exchange-rates']} 
        onClick={toggleSection}
      >
        What Influences Exchange Rates?
      </ClickableHeadline>
      {expandedSections['influences-exchange-rates'] && (
        <>
          <p className="mb-6 text-left">
      ...
      <ClickableHeadline 
        ...
        isExpanded={expandedSections['exchange-rate-volatility']} 
        onClick={toggleSection}
      >
        Exchange Rate Volatility
      </ClickableHeadline>
      {expandedSections['exchange-rate-volatility'] && (
        <>
          <p className="mb-4 text-left">
      ...
      <ClickableHeadline 
        id="compare-exchange-rates" 
        isExpanded={expandedSections['compare-exchange-rates']} 
        onClick={toggleSection}
      >
        How to Compare Exchange Rates
      </ClickableHeadline>
      {expandedSections['compare-exchange-rates'] && (
        <>
          <p className="mb-4 text-left">
          ...
          <div className="space-y-8 ml-4 pl-6 border-l-2 border-indigo-200 mb-8">
            ...
            <div className="relative">
              <div className="absolute left-[-33px] top-1 h-5 w-5 rounded-full bg-indigo-600"></div>
              <h3 className="text-xl font-bold text-gray-700 mb-1 text-left">3. Compare the Effective Exchange Rate</h3>
              <p className="mb-4 text-left">
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-4 text-left">Real-World Example: Comparing Providers</h2>
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-4 mt-8 text-left">Tracking Exchange Rates Over Time</h2>
