                    ...
                    <div className="flex">
                      <div className="relative w-2/5">
                        <button 
                          ...
                          className="h-full appearance-none border-0 bg-gray-100 rounded-l p-3 text-gray-800 focus:outline-none cursor-pointer flex items-center justify-between w-full"
                        >
                          <div className="flex items-center">
